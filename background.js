        ...
        displayAppThemeUserProfile: {
          ...
          childSettings: {
            displayAppThemeOwnProfile: {
              ...
              default: !1,
              donatorTier: 1,
              donatorReason: "Donator Tier 1 is required to display your app theme on your own profile",
...
`);
  ...
  chrome.runtime.onMessage.addListener((message, sender, sendResponse) => { if (message.type !== "settingsCompatGetRes") return false; return (message.type === "settingsCompatGetRes" && (debugVerbose("Recieved signal settingsCompatGetRes.", { message, data: compatResults }), sendResponse(compatResults), compatResults = { replaced: [], deleted: [] }), !0); });
  ...
  async function callRobloxApiBackground(options) {
    ...
    let fetchOptions = { method, credentials: "include", cache: options.noCache ? "no-store" : "default", headers: { ...headers } };
