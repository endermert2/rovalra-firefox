...
See [SUBPLACE-FIX-2.6.9.6.md](SUBPLACE-FIX-2.6.9.6.md) for the current upload checklist.
...
The current adapter revision is 6, producing version **2.6.9.6**. This also avoids
...
2. Download the unsigned XPI from your first release. Alternatively, use the local
   `firefox-port/build/rovalra-firefox-2.6.9.6-unsigned.xpi` prepared here; it contains
